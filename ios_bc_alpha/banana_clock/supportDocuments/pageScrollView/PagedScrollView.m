...
- (void)refreshVisibleCellAppearance{
    ...
    switch (orientation) {
        case PagedScrollViewOrientationHorizontal:{
        ...
        case PagedScrollViewOrientationVertical:{
...
- (void)layoutSubviews{
    ...
    if (_needsReload) {
        ...
        switch (orientation) {
            case PagedScrollViewOrientationHorizontal://横向
                _scrollView.frame = CGRectMake(0, 0, _pageSize.width, _pageSize.height);
                _scrollView.contentSize = CGSizeMake(_pageSize.width * _pageCount,100);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
#pragma mark PagedScrollView API
