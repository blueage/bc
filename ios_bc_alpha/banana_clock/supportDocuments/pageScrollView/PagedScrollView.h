...
@protocol  PagedScrollDelegate<NSObject>
...
typedef enum{
    PagedScrollViewOrientationHorizontal = 0,
    PagedScrollViewOrientationVertical
}PagedScrollViewOrientation;

@interface PagedScrollView : UIView<UIScrollViewDelegate>{
    
    PagedScrollViewOrientation orientation;//默认为横向
...
@property(nonatomic,assign)   id <PagedScrollViewDataSource> dataSource;
@property(nonatomic,assign)   id <PagedScrollDelegate>   delegate;
@property(nonatomic,retain)    UIPageControl       *pageControl;
@property (nonatomic, assign) CGFloat minimumPageAlpha;
@property (nonatomic, assign) CGFloat minimumPageScale;
@property (nonatomic, assign) PagedScrollViewOrientation orientation;
