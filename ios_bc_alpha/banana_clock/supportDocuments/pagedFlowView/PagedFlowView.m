...
-(void)tapAction{
    if ([_delegate respondsToSelector:@selector(tapAtPoint:)]) {
        [_delegate tapAtPoint:_point];
    }
}
...
//    
//    //初始显示哪个
////    if ([[[userModel sharedUserModel] getUserInformationWithKey:@"throwProp"] intValue]>=0) {
////        [self scrollToPage:[[[userModel sharedUserModel] getUserInformationWithKey:@"throwProp"] intValue]];
////    }else{
////        [self scrollToPage:floor((_pageCount-1)/2.0)];
////    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    [_delegate setScrollViewContentOffset:point];
}
