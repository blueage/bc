...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _refleshView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"loading.png"]];
...
{
    //拉断了
    [self performSelector:@selector(endRefresh) withObject:nil afterDelay:20];
    self.broken = YES;
    self.loading = YES;
...
#pragma mark---------开始刷新，doHTTP，准备被子类重写---------
